...
export function BottomNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-background/95 border-t border-border backdrop-blur-md safe-bottom">
        ...
        {showMore && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-50 bg-card rounded-t-3xl border-t border-border p-6 shadow-2xl safe-bottom pointer-events-auto"
            >
              ...
              <div className="grid grid-cols-4 gap-y-6 gap-x-2 pb-4">
                {moreItems.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      cn(
                        "flex flex-col items-center justify-center text-center p-2 rounded-2xl transition-all",
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        <div
                          className={cn(
                            "w-12 h-12 flex items-center justify-center rounded-2xl border border-border bg-card shadow-sm mb-2 transition-all",
