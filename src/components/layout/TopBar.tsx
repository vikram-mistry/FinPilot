...
export function TopBar() {
  ...
  return (
    <header className="h-16 px-4 md:px-6 flex items-center justify-between border-b border-border bg-card/50 backdrop-blur-md sticky top-0 z-30 safe-top">
      {/* Brand on Mobile / Page Heading on Desktop */}
      <div className="flex items-center gap-3">
        <div className="md:hidden flex items-center gap-2">
          <img src="/favicon.svg" alt="FinPilot Logo" className="w-8 h-8 object-contain" />
